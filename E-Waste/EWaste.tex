...
\fancyhead{}
\fancyfoot{}
\fancyfoot[RO]{Toxic Efficiency \hspace{1mm} \textbar \hspace{1mm} \thepage\ }
...
\line(1,0){200}\\
[3in]
\LARGE{Tarini Sudhakar, Akshat Singh, and Shubham Singh} \\ 
[1.5cm]
...
\subsubsection{Mandatory Collection Targets}
                    ...
                    The EWM Rules, 2016, also sought to improve the success rate of EPR implementation by introducing mandatory minimum collection targets for each producer \parencite{pibreport}. The EPR collection target was set as 30\% of the quantity of waste generated by the producers for 2016 to 2018.\footnote{See Schedule III of the EWM Rules, 2016} This target would increase in subsequent years, and by 2022, the producers would have to collect 70\% of the waste generated. \\
...
\begin{figure}[H]
\centering
\includegraphics[height = 3.8in]{fig2.png}
...
\begin{figure}[H]
\flushleft
\includegraphics[height= 3.93in]{fig3.png}
...
\begin{figure}[H]
\centering
\includegraphics[height = 4.45in]{fig4.png}
...
\addcontentsline{toc}{section}{Appendix 3: Additional Requirements for Authorising Recyclers}
        ...
        According to the Implementation Guidelines given by the CPCB\footnote{See {\href{http://cpcb.nic.in/cpcbold/GUIDELINES_E\%20WASTE_RULES_2016.pdf}{Implementation Guidelines for E-Waste (Management) Rules, 2016}}.} for the EWM Rules, 2016, a recycling facility needs to provide the following to the SPCB:
