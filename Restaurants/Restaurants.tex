...
%Table 1: Time, Cost, Validity and Procedure of Mandatory Licences in Delhi
 %table 1 needs to go here. also table 1 has footnotes #7/8/9 from the word doc. 
 	...
 	\begin{tabular}{p{2.5cm} | p{2.5cm} | p{3cm} | p{2.5cm} | p{2cm}}
		\multirow {2}{*}{\bf{\thead{Days to obtain}}}		&	\multirow {2}{*}{\bf{\thead{Official Cost}}}							&	\multirow {2}{*}{\bf{\thead{Validity}}}		&	\multirow {2}{*}{\bf{\thead{How to Apply}}}	&	\multirow {2}{*}{\bf{\thead{Issuing Government}}}\\
		&\textit{\footnotesize{Rs} & \textit{\footnotesize{Years}&&\\
		\hline
