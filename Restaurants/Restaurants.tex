...
%             \lfoot{  \leftmark }     			% get the section heading on the footer 
   ...
   %=============TODO
		...
		% need to add figure/table labels for hyperrefs? my hyperrefs of section names are wrong
...
%i want to re-edit intro. it is not flowing nicely and paras are currently too small. also need to hyperref appendix. also should we do superscript for 'th' and how?
...
%this is listed as table 4 in the word doc but really it is table 3. should we be deducting points from the proofer for missing this?
		...
		The Controller of Weights and Measures issues this licence according to the Legal Metrology Act 2009. Every manufacturer/dealer/repairer of weights and measures is required to obtain this licence to carry out his/her trade. The purpose of the licence is to ensure that the customer is being served the right quantity of food or drink that he/she has ordered without being defrauded in any manner, either in quantity served or in price charged.\\
...
%reformatted the questionnaire from the word version, and need to check how the embedded lists turn out.
