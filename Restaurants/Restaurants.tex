...
%Table 1: Time, Cost, Validity and Procedure of Mandatory Licences in Delhi
	...
	\begin{tabular}{L{2.5cm} | L{4cm} | C{3cm} | C{2.5cm} | C{2.5cm}}
		\hline
		\bf{\thead{Days to obtain}}	&	\bf{\thead{\shortstack{Official Cost \\ \textit{\tiny{In Rs.}}}}} &	\bf{\thead{\shortstack{Validity \\ \textit{\tiny{Years}}}}}	&	\bf{\thead{How to Apply}}	&	\bf{\thead{Issuing Govt.}}\\
		\hline
		\hline
		\multicolumn {5}{l}{\bf{\thead{Food Safety Licence}}}\\
		60	& 7,500/year: Centre \newline 2,000/year: State  &	 Up to 5		&	Online				&	Centre/State\\
		\hline
		\multicolumn {5}{l}{\bf{\thead{Health Trade Licence}}}\\ 	
		...
		\hline 
		\multicolumn {5}{c}{\bf{\thead{Fire Safety Certificate}}}\\
		15	&	No charge	&	3	&	Online for new building 	&	State\\
		\hline 
		\multicolumn {5}{c}{\bf{\thead{Consent to Establish/Operate}}}\\
		120\footnote{Deemed clear if delayed beyond 120 days}	&	No charge	&	1	&	Online	&	State\\
		\hline 
		\multicolumn {5}{c}{\bf{\thead{Shops and Establishment Licence}}}\\
		Immediately	&	No charge	&	24	&	Online	&	State\\
		\hline
		\multicolumn {5}{c}{\bf{\thead{Eating House Licence}}}\\
		...
		\hline 
		\multicolumn {5}{c}{\bf{\thead{GST registration}}}\\
		3	&	No charge	&		&	Online 	&	Central/State\\
		\hline
		\multicolumn {5}{c}{\bf{\thead{Signage Licence}}}\\
...
%this is listed as table 4 in the word doc but really it is table 3. should we be deducting points from the proofer for missing this?
	...
	\begin{tabular}{L{2.5cm} | L{1.5cm} | L{4.5cm} | C{2cm} | C{2cm} | C{1.5cm}}
		\hline
		\bf{\thead{License}} & 	\bf{\thead{TIme}}	&	\bf{\thead{\shortstack{Official Cost \\ \textit{\tiny{In Rs.}}}}} &	\bf{\thead{\shortstack{Validity \\ \textit{\tiny{Years}}}}}	&	\bf{\thead{Application}}	&	\bf{\thead{Issuer}}\\
		\hline
		\hline
		\multicolumn {6}{l}{\bf{\thead{Serving Alcohol}}}\\
