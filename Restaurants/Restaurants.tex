...
%Table 1: Time, Cost, Validity and Procedure of Mandatory Licences in Delhi
		...
		\begin {table}[htpb]
		\raggedright
		\caption{Mandatory Licences for an FBO in Delhi: Time, Cost, Validity and How to Apply}}
		\begin{tabular}{p{1cm} | p{1cm} | p{2cm} | p{2cm} | p{2cm} | p{2cm}}
			\multirow {2}{*}{\bf{\thead{\footnotesize{Licences}}} & \multirow {2}{*}{\bf{\thead{\footnotesize{Days to Obtain}}}} & \bf{\thead{\footnotesize{Official Cost}} & \bf{\thead{\footnotesize{Validity}} & \multirow {2}{*}{\bf{\thead{\footnotesize{How to Apply}}} & \multirow {2}{*}{\bf{\thead{\footnotesize{Issuing Government}}}\\
			&&\textit{\thead{\footnotesize{(in Rs.)}}} &\textit{\thead{\footnotesize{(Years)}}}\\
			\hline
			\hline
			\multirow {2}{*}{Food Safety Licence} &	\multirow {2}{*}{60}	&	7,500/year: Central Licence		&\multirow {2}{*}{1 to 5 (as chosen by FBO)}	  &	\multirow {2}{*}{Online}		&	\multirow {2}{*}{Central or State}\\
			&&2,000/year: State Licence&&&\\
		\end{tabular}
		\end{table}
