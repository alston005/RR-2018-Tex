...
from the police to start their unit.}
 			...
 			\begin{figure}[H]
                    		...
                    		\caption[Optional Caption]{Ease of Obtaining Licences from the DPCC, Department of Labour and Delhi Police}
			\end{figure}
...
families to eat in the restaurant while off-duty and leave without paying the bill.
		...
		\begin{figure}[H]
                    	...
                    	\caption[Optional Caption]{Perception of Restaurateurs on the Intention of the Inspectors and Payment of Bribes}\footnote{The remaining respondents marked ‘No’} % need to fix this figure: remove bribes, and keep simple. if this happens, you can remove the footnote. plus in current syntax, footnote error. 
		\end{figure}
...
Corporation Act, 1957. At present, there are 135 urban villages in Delhi. Norms for these villages are laid down in the Master Plan Delhi 2021, however, these villages remain exempted from sealing.} 
		...
		\begin{figure}[H]
                    	\centering
                    	\includegraphics[height = 3.5in]{Figure9.png}
