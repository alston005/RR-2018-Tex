...
\fancyhead{}
\fancyfoot{}
\fancyfoot[RO]{A Seven Course Dilemma \hspace{1mm} \textbar \hspace{1mm} \thepage\ }
...
%BIBLIOGRAPHY and LINKS
		...
		\addbibresource{Restaurants.bib}      
 		\usepackage{hyperref} 
		\hypersetup{
		colorlinks,
		linkcolor = black,
...
%Mandatory Licences: Convoluted and Ambiguous
...
\endfoot
\endlastfoot
	\multicolumn {5}{c}{\bf{Food Safety Licence}}\\
	\midrule
		60	& 7,500/year: Centre \newline 2,000/year: State  &	 1 to 5 (as chosen by the FBO)		&	Online				&	Centre/ State\\
		& & &  & \\
		
	\midrule
	\multicolumn {5}{c}{\bf{Health Trade Licence}}\\
	\midrule
		Immediately\footnote{Verification of documents within 60 days} &	16,000: 20 seats \newline19,000: 20-50 seats \newline 31,000: 50+ seats &	1	&	Online	&	Local\\ 
		& & &  & \\
	\midrule
	\multicolumn {5}{c}{\bf{Fire Safety Certificate}}\\
	\midrule
	15	&	No charge	&	3	&	Online for new building 	&	State\\
	& & &  & \\
	\midrule
	\multicolumn {5}{c}{\bf{Consent to Establish/Operate}}\\
	\midrule
	120\footnote{Deemed clear if delayed beyond 120 days}	&	No charge	&	1	&	Online	&	State\\
	& & &  & \\
		\midrule
	\multicolumn {5}{c}{\bf{Shops and Establishment Licence}}\\
	\midrule
	Immediately	&	No charge	&	24	&	Online	&	State\\
	& & &  & \\
	\midrule
	\multicolumn {5}{c}{\bf{Eating House Licence}}\\
	\midrule
	55	&	300: Application \newline 200: Renewal	&	Contingent on other licences	&	Offline\footnote{Application form for an Eating House Licence has to be filled online, however, the form, along with documents required, have to be submitted physically at the office of the Licensing Unit of Delhi Police.}	&	State\\
	\midrule
	\multicolumn {5}{c}{\bf{GST registration}}\\
	\midrule
	3	&	No charge	&		&	Online 	&	Central/ State\\
	& & &  & \\
	\midrule
	\multicolumn {5}{c}{\bf{Signage Licence}}\\
	\midrule
...
\centering
		\begin{tabular}{L{3.5cm}L{4cm}C{3.25cm}C{3.25cm}}
				\toprule
			\multirow {2}{*}{Turnover} & \multirow {2}{*}{Information Source} & \multicolumn {2}{c}{{Type of Licence}}\\
...
of 1974.\footnote{\href{https://bit.ly/2pbaWOw}{The Air (Prevention and Control of Pollution) Act, 1981} (Accessed 31 June 2018).} \footnote{\href{https://bit.ly/2xcUyRW}{The Water (Prevention and Control of Pollution) Act, 1974} (Accessed 3 July 2018).}  %need to check if the hyperlink of the footnotes is correct. 
...
%Overall Ease of the Licensing Procedure and Costs Involved		
...
%Restaurateur's Perception of the Inspections Regime
...
%What Are You Expected To Do When Faults Are Found?		
...
%What Do You Think Is the Intent of the Inspectors?		
...
families to eat in the restaurant while off-duty and leave without paying the bill.\\
		...
		\begin{figure}[H]
                    	...
                    	\captionsetup{justification=centering}\caption[Optional Caption]{Perception of Restaurateurs on the Intention of the Inspectors} %removed paying bribes from here. also need to try and redo this one so each option fits on one line
		\end{figure}

%What Is Your Opinion of the Inspectors?
...
%=======================================APPENDIX=================================================              
		...
		\begin{figure}[H]
                    	\centering
                    	\includegraphics{"Appendix1 - pg1".jpg} 
		\end{figure}
		
		\begin{figure}[H]
                    	\centering
                    	\includegraphics{"Appendix1 - pg2".jpg} 
		\end{figure}
...
Corporation Act, 1957. At present, there are 135 urban villages in Delhi. Norms for these villages are laid down in the Master Plan Delhi 2021, however, these villages remain exempted from sealing.} 
		...
		\begin{figure}[H]
                    	...
                    	\captionsetup{justification=centering}\caption[Optional Caption]{Parameters for the Sample}%edited the caption 
		\end{figure}
