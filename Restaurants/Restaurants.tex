...
%BIBLIOGRAPHY and LINKS
		...
		\addbibresource{bibliography_new.bib}      
 		\usepackage{hyperref} 
		\hypersetup{
		colorlinks,
		linkcolor = black,
...
%should we be checking the list again for comprehensiveness? i suspect there are more abbrvs that are not listed here. for all papers. 
   ...
   %=============TODO and NOTES
		...
		% in tables: table caption at the top but figure caption at the bottom, footnotes are not showing up
		% do we need to hyperref tables/figures where referenced?
		% unable to do enumerate A,B,C
		% title page restyled: should we do all like this?
...
and ‘give officials the power to deny them and to collect bribes in return for providing the permits’ (\cite{stigler1971theory}, p. 3; \cite{shleifer1993corruption}, p. 601).\\ %we have a reference problem. stigler was not a public choice theorist though he did add to the school of thought. 
...
\endlastfoot
	...
	\midrule
		60	& 7,500/year: Centre \newline 2,000/year: State  &	 Up to 5		&	Online				&	Centre/ State\\
		& & &  & \\
		
	\midrule
	\multicolumn {5}{c}{\bf{Health Trade License}}\\
	\midrule
 ...
 % issues: margins may be tight, footnotes not showing up, table caption at the top but figure caption at the bottom
...
\centering
		\begin{tabular}{L{3.5cm}L{4cm}C{3.25cm}C{3.25cm}}
				\toprule
			\multirow {2}{*}{Turnover} & \multirow {2}{*}{Information Source} & \multicolumn {2}{c}{{Type of License}}\\
		...
		\end{tabular}
		\end{table}  	
		\footnotetext{Food Safety and Standards Regulations, 2011, Schedule I, Point 9.}	

% issues: table caption at the top but figure caption at the bottom, also could be prettier.
