...
%Table 1: Time, Cost, Validity and Procedure of Mandatory Licences in Delhi
	...
	\begin{tabular}{L{3cm} | L{3.5cm} | L{3.5cm} | L{3.5cm} | L{2.5cm}}
	\bf{\thead{Days to obtain}}	&	\bf{\thead{Official Cost \newline{\textit{\tiny{In Rs.}}}	&	\bf{\thead{Validity \newline{\textit{\tiny{Years}}}	&	\bf{\thead{How to Apply}}	&	\bf{\thead{Issuing Govt.}}\\
		\hline
		\hline
		\multicolumn {5}{c}{\bf{\thead{Food Safety Licence}}}\\
		\hline
		60	&	7,500/year: Central \newline 2,000/year: State &	 1 to 5 \newline as chosen by FBO		&	Online				&	Centre or State\\
		\hline
		\multicolumn {5}{c}{\bf{\thead{Health Trade Licence}}}\\ 	
		\hline 
		Immediately at application &	16,000: 20 seats \newline19,000: 20-50 seats \newline 31,000: 50+ seats &	1	&	Online	&	Local\\ 
		\hline 
		\multicolumn {5}{c}{\bf{\thead{Fire Safety Certificate}}}\\
		\hline 
		15	&	No charge	&	3	&	New bldgs: Online \newline Old bldgs: Offline	&	State\\
		\hline 
		\multicolumn {5}{c}{\bf{\thead{Consent to Establish/Operate}}}\\
		\hline 	
		120 \newline deemed clear after	&	No charge	&	1	&	Online	&	State\\
		\hline 
		\multicolumn {5}{c}{\bf{\thead{Shops and Establishment Licence}}}\\
		\hline 
		Immediately at application	&	No charge	&	24	&	Online	&	State\\
		\hline 
		\multicolumn {5}{c}{\bf{\thead{Eating House Licence}}}\\
		\hline
		55	&	300: Application \newline 200: Renewal	&	Contingent on the validity of other licences	&	Offline	&	State\\
		\hline 
		\multicolumn {5}{c}{\bf{\thead{GST registration}}}\\
		\hline
		3	&	Free	&		&	Online 	&	Central and State\\
		\hline
		\multicolumn {5}{c}{\bf{\thead{Signage Licence}}}\\
		\hline
		30	&	$<$4ft.: Free \newline $>$4ft: Rs. 100/sq.ft	&	Maximum period of 5 years 	&	Offline	&	Local\\ 
	\end {tabular}
	\end {table}

 % several issues: spilling over across pages, and footnotes (#7/8/9 from the word doc)
