...
%this is listed as table 4 in the word doc but really it is table 3. should we be deducting points from the proofer for missing this?
		...
		\caption{Time, Cost, Validity and Procedure of Service-Specific Licences in Delhi}
			...
			\bf{\thead{\footnotesize{Services}} & \bf{\thead{\footnotesize{Licences}} & \bf{\thead{\footnotesize{Time (Day)}} & \bf{\thead{\footnotesize{Official Cost (Rs.)}} & \bf{\thead{\footnotesize{Validity (Year)}} & \bf{\thead{\footnotesize{Online/Offline}} & \bf{\thead{\footnotesize{Issuing Government}} &\\
			\hline
				
	Serving Alcohol		&	Approval from the Department of Tourism	&	21		10,000 (up to 100 seats)\\15,000 (100+ seats)											&5							&	Online		&	State 
					&	L17/L17F Excise Licence				&	28		7,64,993 (50 seats)\\10,87,095 (50-100 seats)\\14,49, 459 (100-200 seats)\\18,52, 087 (200+ seats)	&1							&	Online		&	State 
					&	Weights and Measures Licence			&	30		100 (Peg measures of 30 ml, 60 ml and 100 ml)										&2							&	Partially online	&	State 
	Installing Lift		&	Lift Clearance 						&	7		520 (for speed up to 1m/s)\\770 (for speed up to 1.5 m/s)\\1,020 (for speed above 1.5 m/s)		&1							&	Online		&	State 
	Playing Music		&	Music Licence						&	Varies	3,500 (Up to 30 seats)\\7,500 (30-50)\\10,000 (50+)										&1-3 years (as chosen by FBO) 	&	Offline		&	Private
...
case they were not available, we interviewed managers or members of the licensing department.
		...
		\begin{table}[htpb]
			...
			\bf{\thead{\normalsize{Area}} & \bf{\thead{\normalsize{Zone}} & \bf{\thead{\normalsize{Respondents}} & \bf{\thead{\normalsize{Area}} & \bf{\thead{\normalsize{Zone}} & \bf{\thead{\normalsize{Respondents}} \\
			\hline
...
inspectors, inspection checklists, inspection reports and if there was a grievance redressal system in case the restaurateur feels dissatisfied with the inspection process.
	...
	\paragraph {Section 1: Restaurant Information}
		\begin {enumerate}[nosep]
