...
%             \lfoot{  \leftmark }     			% get the section heading on the footer 
		...
		\addbibresource{bibliography8.bib}
		\usepackage{hyperref}
		\hypersetup{
		colorlinks, 
		linkcolor = black, 
...
\begin{minipage}[t]{.4\textwidth}
  ...
  \captionof{figure}{Food hygiene ratings displayed on the Zomato app. The screenshot was taken on 20 July 2018.}
\end{minipage}\hspace{0.5em} \vrule \hspace{0.5em}
\begin{minipage}[t]{.6\textwidth}
  \includegraphics[width=1\linewidth]{fig2-al.png}
  \captionof{figure}{Breakdown of the hygiene ratings of a restaurant on the Zomato app. The screenshot was taken on 23 June 2018.}
  %\label{fig:test2}
\end{minipage}
\end{figure}
