...
\begin{minipage}[t]{.4\textwidth}
  ...
  \captionof{figure}{Food hygiene ratings displayed on the Zomato app as updated on 20 July 2018.}
\end{minipage}\hspace{0.5em} \vrule \hspace{0.5em}
\begin{minipage}[t]{.6\textwidth}
  \includegraphics[width=1\linewidth]{fig2-al.png}
  \captionof{figure}{Breakdown of the hygiene ratings of a restaurant on the Zomato app as updated on 23 June 2018.}
  %\label{fig:test2}
\end{minipage}
\end{figure}
