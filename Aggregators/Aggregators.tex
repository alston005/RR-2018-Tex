...
\fancyhead{}
\fancyfoot{}
\fancyfoot[RO]{ Disruption on Demand \hspace{1mm} \textbar \hspace{1mm} \thepage\ }
...
\captionsetup{justification=raggedright,singlelinecheck=false}
 ...
 \captionsetup[table]{singlelinecheck = false}
		...
		\addbibresource{Aggregators.bib}
		\usepackage{hyperref}
		\hypersetup{
		colorlinks, 
		linkcolor = black, 
...
\begin{minipage}[t]{.4\textwidth}
  \includegraphics[width=.8\linewidth]{fig1-al.png} \hfill
 \captionsetup{justification=centering}\captionof{figure}{Food Hygiene Ratings Displayed on the Zomato App as Updated on 20 July 2018.}
\end{minipage}\hspace{0.5em} \vrule \hspace{0.5em}
\begin{minipage}[t]{.6\textwidth}
 \includegraphics[width=1\linewidth]{fig2-al.png}
 \captionsetup{justification=centering}\captionof{figure}{Breakdown of the Hygiene Ratings of a Restaurant on the Zomato App as Updated on 23 June 2018.}
  %\label{fig:test2}
\end{minipage}
\end{figure}
...
Similarly, Meru Cabs, a taxi cab service based in Mumbai, accused Uber of following predatory pricing in order to increase their market share. The chief executive officer of Meru Cabs, Nilesh Sangoi, reasons that the huge subsidy given to drivers and impractical discounts to customers offered by Uber has distorted the taxi service market \parencite{Kalra2017}.\\
...
Most regulations that currently apply to service providers ignore the idea that every current market failure is an opportunity, incentivising entrepreneurial efforts to tackle it \parencite{thierer2015internet}. \\
...
%Appendix
  \section*{Appendix 1: Amenities Provided by Airbnbs}
             \addcontentsline{toc}{section}{Appendix 1: Amenities Provided by Airbnbs}
\small
\centering
...
%APPENDIX 2
 ...
 \section*{Appendix 2: Sentiment Analysis for Reviews of all Airbnbs}
             \addcontentsline{toc}{section}{Appendix 2: Sentiment Analysis for Reviews of all Airbnbs}
\footnotesize
\centering
