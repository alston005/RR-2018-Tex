...
%             \lfoot{  \leftmark }     			% get the section heading on the footer 
    ...
    %    	{\huge Researching Reality Internship 2018} \\
     %   	[0.5cm]
    	...
    	[2.0cm]
    	\includegraphics[width = 75mm]{/Users/pushyami/Desktop/LatexR/unnamed.png}
